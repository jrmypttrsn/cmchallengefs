<div>
    <div class="w-full space-y-3">
        ...
        <div>
            <label for="quality_perspective" class="mb-1 inline-block">When creating products, which best describes your perspective on quality?</label>
        ...
        <div>
            <label for="seller_experience" class="mb-1 inline-block">How would you describe your experience level as an online seller?</label>
            <select class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
        ...
        <div>
            <label for="marketing_understanding" class="mb-1 inline-block">How would you describe your understanding of business and marketing?</label>
            <select class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"
